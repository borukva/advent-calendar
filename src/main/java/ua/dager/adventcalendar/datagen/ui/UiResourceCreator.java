...
import static ua.dager.adventcalendar.AdventCalendar.id;
...
public class UiResourceCreator {
    ...
    public static void generateAssets(BiConsumer<String, byte[]> assetWriter) {
        ...
        assetWriter.accept("assets/" + AdventCalendar.MOD_ID + "/font/gui.json", fontBase.toString().getBytes(StandardCharsets.UTF_8));
    }
